...
@section('content')
    <section class="mt-5 pt-5 position-relative" style="min-height: 100vh;">
        <div class="container px-3 px-md-5 position-relative" style="min-height: 90vh;">
            ...
            <form id="requests.destroy" action="{{ route('new_resident.requests.destroy', $latestRequest->resident_id) }}"
                method="POST">
                @method('DELETE')
                @csrf
            </form>

            <form id="requests.store" action="{{ route('new_resident.requests.update', $latestRequest) }}" method="POST"
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="alias" placeholder="Nickname(Optional)" value="{{ old('alias') ?? $resident->alias }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="text"
                        ...
                        value="{{ old('birth_date') ?? $resident->birth_date }}" id="birthdate" required>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="place_of_birth" placeholder="Birthplace"
                        value="{{ old('place_of_birth') ?? $resident->place_of_birth }}" required>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <select
                        ...
                        name="sex" value="{{ old('sex') ?? $resident->sex }}" required style="border-radius: 10px">
                        <option value="" disabled selected>Sex</option>
                        <option value="male" {{ old('sex') ?? $resident->sex == 'male' ? 'selected' : '' }}>Male</option>
                        <option value="female" {{ old('sex') ?? $resident->sex == 'female' ? 'selected' : '' }}>Female
                        </option>
                    </select>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        value="{{ old('citizenship') ?? $resident->citizenship }}" required>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <select
                        ...
                        name="civil_status" value="{{ old('civil_status') ?? $resident->civil_status }}" required
                        style="border-radius: 10px">
                        <option value="" disabled selected>Civil Status</option>
                        <option value="single"
                            {{ old('civil_status') ?? $resident->civil_status == 'single' ? 'selected' : '' }}>Single
                        </option>
                        <option value="married"
                            {{ old('civil_status') ?? $resident->civil_status == 'married' ? 'selected' : '' }}>Married
                        </option>
                        <option value="Widowed"
                            {{ old('civil_status') ?? $resident->civil_status == 'Widowed' ? 'selected' : '' }}>Widowed
                        </option>
                        <option value="Divorced"
                            {{ old('civil_status') ?? $resident->civil_status == 'Divorced' ? 'selected' : '' }}>Divorced
                        </option>
                    </select>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="religion" placeholder="Religion" value="{{ old('religion') ?? $resident->religion }}"
                        required>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="blood_type" placeholder="Blood Type"
                        value="{{ old('blood_type') ?? $resident->blood_type }}" required>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <select
                        ...
                        name="pwd" value="{{ old('pwd') ?? $resident->pwd }}" required style="border-radius: 10px">
                        <option value="" disabled selected>PWD?</option>
                        <option value="yes" {{ old('pwd') ?? $resident->pwd == 'yes' ? 'selected' : '' }}>Yes</option>
                        <option value="no" {{ old('pwd') ?? $resident->pwd == 'no' ? 'selected' : '' }}>No</option>
                    </select>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="number" min="1"
                        ...
                        value="{{ old('years_of_residence') ?? $resident->years_of_residence }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <select
                        ...
                        name="member_4ps" value="{{ old('member_4ps') ?? $resident->member_4ps }}" required
                        style="border-radius: 10px">
                        <option value="" disabled selected>4Ps Member?</option>
                        <option value="yes" {{ old('member_4ps') ?? $resident->member_4ps == 'yes' ? 'selected' : '' }}>
                            Yes</option>
                        <option value="no" {{ old('member_4ps') ?? $resident->member_4ps == 'no' ? 'selected' : '' }}>No
                        </option>
                    </select>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <select
                        ...
                        name="voter_status" value="{{ old('voter_status') ?? $resident->voter_status }}" required
                        style="border-radius: 10px">
                        <option value="" disabled selected>Voter's Status</option>
                        <option value="Voter"
                            {{ old('voter_status') ?? $resident->voter_status == 'Voter' ? 'selected' : '' }}>Voter
                        </option>
                        <option value="Non-voter"
                            {{ old('voter_status') ?? $resident->voter_status == 'Non-voter' ? 'selected' : '' }}>
                            Non-voter
                        </option>
                    </select>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <select
                        ...
                        name="identified_as" value="{{ old('identified_as') ?? $resident->identified_as }}" required
                        style="border-radius: 10px">
                        <option value="" disabled selected>Identified as</option>
                        <option value="Active Voter"
                            {{ old('identified_as') ?? $resident->identified_as == 'Active Voter' ? 'selected' : '' }}>
                            Active Voter
                        </option>
                        <option value="Inactive Voter"
                            {{ old('identified_as') ?? $resident->identified_as == 'Inactive Voter' ? 'selected' : '' }}>
                            Inactive Voter
                        </option>
                    </select>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="floor_no" placeholder="Floor Number (Optional)"
                        value="{{ old('floor_no') ?? $resident->floor_no }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="block_no" placeholder="Block Number (Optional)"
                        value="{{ old('block_no') ?? $resident->block_no }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        value="{{ old('street_name') ?? $resident->street_name }}" required>
                ...
                <div class="col-12 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        value="{{ old('family_relation') ?? $resident->family_relation }}" required>
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <select
                        ...
                        name="emp_stat" value="{{ old('emp_stat') ?? $resident->emp_stat }}" required
                        style="border-radius: 10px">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="occupation" placeholder="Occupation (Optional)"
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="emp_name" placeholder="Employer's Name (Optional)"
                        value="{{ old('emp_name') ?? $resident->emp_name }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="number"
                        ...
                        value="{{ old('monthly_income') ?? $resident->monthly_income }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="sss_no" placeholder="SSS No. (Optional)" value="{{ old('sss_no') ?? $resident->sss_no }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="tin_no" placeholder="TIN No. (Optional)" value="{{ old('tin_no') ?? $resident->tin_no }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="gsis_no" placeholder="GSIS No. (Optional)"
                        value="{{ old('gsis_no') ?? $resident->gsis_no }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="pagibig_no" placeholder="PAGIBIG No. (Optional)"
                        value="{{ old('pagibig_no') ?? $resident->pagibig_no }}">
                ...
                <div class="col-12 col-md-6 col-lg-3 position-relative">
                    <input type="search" autocomplete="off"
                        ...
                        name="philhealth_no" placeholder="PhilHealth No. (Optional)"
                        value="{{ old('philhealth_no') ?? $resident->philhealth_no }}">
